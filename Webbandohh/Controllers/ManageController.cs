    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Mật khẩu của bạn đã đuợc thay đổi"
                : message == ManageMessageId.SetPasswordSuccess ? "Mật khẩu của bạn đã được đặt lại"
                : message == ManageMessageId.SetTwoFactorSuccess ? "Xác thực hai bước đã được đặt"
                : message == ManageMessageId.Error ? "Đã xảy ra lỗi."
                : message == ManageMessageId.AddPhoneSuccess ? "Thêm số điện thoại thành công."
                : message == ManageMessageId.RemovePhoneSuccess ? "Xoá số điện thoại thành công."
                : "";
